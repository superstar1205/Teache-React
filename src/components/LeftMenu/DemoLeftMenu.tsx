            ...
            {menuCollapse ? (
              ...
              >
                <div className="sidebar-brand-text mx-3">
                  ...
                  >
                    <g clip-path="url(#clip0_257_1537)">
                      <path d="M63 0H0V63H63V0Z" fill="#554DF1" />
                      <path
                        d="M31.5 56.1094C45.031 56.1094 56 45.0914 56 31.5C56 17.9086 45.031 6.89062 31.5 6.89062C17.969 6.89062 7 17.9086 7 31.5C7 45.0914 17.969 56.1094 31.5 56.1094Z"
                        fill="white"
                      />
                      <path
                        d="M48 31.9921C48 33.3657 47.5287 34.5292 46.5856 35.4833C45.6808 36.399 44.5491 36.8567 43.1915 36.8567C41.8713 36.8567 40.7211 36.399 39.7406 35.4833C38.7975 34.5292 38.3262 33.3657 38.3262 31.9921C38.3262 29.97 37.6096 28.234 36.1764 26.7841C34.7432 25.2961 33.0273 24.5521 31.0283 24.5521C28.9917 24.5521 27.2568 25.2961 25.8237 26.7841C24.3905 28.234 23.6739 29.97 23.6739 31.9921C23.6739 34.0144 24.3905 35.7693 25.8237 37.2573C27.2568 38.7072 28.9917 39.4321 31.0283 39.4321C32.3107 39.4321 33.4233 39.9091 34.3661 40.8629C35.3466 41.7786 35.837 42.9232 35.837 44.2969C35.837 45.6322 35.3657 46.7767 34.4226 47.7305C33.4798 48.6846 32.3484 49.1804 31.0283 49.2187C26.2385 49.1423 22.2407 47.4635 19.035 44.1823C15.8292 40.901 14.1509 36.8377 14 31.9921C14.1509 27.1466 15.8103 23.1023 18.9784 19.8592C22.1842 16.5779 26.182 14.8801 30.9717 14.7656C35.7993 14.8801 39.8159 16.597 43.0218 19.9164C46.2653 23.1976 47.9247 27.2229 48 31.9921ZM26.2197 31.9921C26.2197 30.6568 26.6722 29.5121 27.5774 28.5583C28.5203 27.5663 29.6706 27.0703 31.0283 27.0703C32.3484 27.0703 33.4798 27.5663 34.4226 28.5583C35.4034 29.5121 35.8934 30.6568 35.8934 31.9921C35.8934 33.3657 35.4034 34.5292 34.4226 35.4833C33.4798 36.399 32.3484 36.8567 31.0283 36.8567C29.6706 36.8567 28.5203 36.399 27.5774 35.4833C26.6722 34.5292 26.2197 33.3657 26.2197 31.9921Z"
                        fill="#554DF1"
                      />
                    </g>
                    <defs>
                      <clipPath id="clip0_257_1537">
              ...
              <a
                className="sidebar-brand d-flex align-items-center justify-content-center"
                href="/"
                style={{ padding: "24px", marginBottom: "1px" }}
              >
                <div className="sidebar-brand-text mx-3">
                  {" "}
                  <svg
                    ...
                    xmlns="http://www.w3.org/2000/svg"
                  >
                    <g clip-path="url(#clip0_257_1536)">
                      <path
          ...
          <Menu iconShape="round">
            <MenuItem>
              ...
              >
                ...
                />
                <span className="side-menu-text">Log out</span>
              </NavLink>
            </MenuItem>
          </Menu>
        </SidebarFooter>
